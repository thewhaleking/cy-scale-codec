...
from scalecodec._primitives import (
    ScaleIntPrimitive,
    U8,
    U16,
    U32,
...
class TestScaleTypeEncoding(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.metadata_decoder = RuntimeConfiguration().create_scale_object(
            "MetadataVersioned",
            data=ScaleBytes(cls.metadata_fixture_dict["kusama_test"]),
        )
    ...
    def test_struct_encode_decode(self):
        ...
        obj_check = RuntimeConfiguration().create_scale_object(
            "ValidatorPrefsTo145", data
        )
    ...
    def test_struct_encode_tuple(self):
        TestStruct = type(
            "TestStruct", (Struct,), {"type_mapping": (("aye", "u32"), ("nay", "u32"))}
        )
    ...
    def test_struct_encode_int(self):
        TestStruct = type(
            "TestStruct", (Struct,), {"type_mapping": (("nonce", "u32"),)}
        )
    ...
    def test_proposal_encode_decode(self):
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "Box<Proposal>", metadata=self.metadata_decoder
        )
        data = obj.encode(value)

        obj_check = RuntimeConfiguration().create_scale_object(
            "Box<Proposal>", data, metadata=self.metadata_decoder
        )
    ...
    def test_multi_encode(self):
        as_multi = RuntimeConfiguration().create_scale_object(
        ...
        self.assertEqual(
            str(as_multi.data),
            "",
        )

    def test_call_encode_invalid_type(self):
        call = RuntimeConfiguration().create_scale_object(
            "Call", metadata=self.metadata_decoder
        )
        self.assertRaises(
            TypeError,
...
class TestScaleIntPrimitive(unittest.TestCase):
    ...
    def _decode(self, type_str, hex_data):
        obj = RuntimeConfiguration().create_scale_object(
            type_str, data=ScaleBytes(hex_data)
        )
        obj.decode()
        return obj
