...
class TestScaleTypes(unittest.TestCase):
    ...
    def test_value_equals_value_serialized_and_value_object(self):
        obj = RuntimeConfiguration().create_scale_object(
            "(Compact<u32>,Compact<u32>)", ScaleBytes("0x0c00")
        )
        obj.decode()
    ...
    def test_compact_u32(self):
        obj = RuntimeConfiguration().create_scale_object(
            "Compact<u32>", ScaleBytes("0x02093d00")
        )
        obj.decode()
    ...
    def test_f64(self):
        obj = RuntimeConfiguration().create_scale_object(
            "f64", ScaleBytes("0x0000000000000080")
        )
        obj.decode()
    ...
    def test_bounded_vec_encode(self):
        ...
        self.assertEqual(
            str(value),
            "0x04e1781813275653a970b4260298b3858b36d38e072256dad674f7c786a0cae236",
        )

        obj = RuntimeConfiguration().create_scale_object(
            "BoundedVec<Option<RegistrarInfo<BalanceOf, AccountId>>,5>"
        )
    ...
    def test_moment(self):
        obj = RuntimeConfiguration().create_scale_object(
            "Compact<Moment>", ScaleBytes("0x03d68b655c")
        )
        obj.decode()
    ...
    def test_type_registry(self):
        ...
        self.assertRaises(
            NotImplementedError,
            RuntimeConfiguration().create_scale_object,
            "SpecificTestType",
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "SpecificTestType", ScaleBytes("0x06000000")
        )
        obj.decode()
        self.assertEqual(obj.value, 6)
    ...
    def test_type_registry_overloading(self):
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "BlockNumber", ScaleBytes("0x0000000000000001")
        )
        self.assertRaises(RemainingScaleBytesNotEmptyException, obj.decode)
    ...
    def test_dynamic_set(self):
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "WithdrawReasons", ScaleBytes("0x0100000000000000")
        )
        obj.decode()
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "WithdrawReasons", ScaleBytes("0x0300000000000000")
        )
        obj.decode()
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "WithdrawReasons", ScaleBytes("0x1600000000000000")
        )
        obj.decode()
    ...
    def test_set_value_type_u32(self):
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "CustomU32Set", ScaleBytes("0x0100000000000000")
        )
        self.assertRaises(RemainingScaleBytesNotEmptyException, obj.decode)

        obj = RuntimeConfiguration().create_scale_object(
            "CustomU32Set", ScaleBytes("0x01000000")
        )
        obj.decode()
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "CustomU32Set", ScaleBytes("0x03000000")
        )
        obj.decode()
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "CustomU32Set", ScaleBytes("0x16000000")
        )
        obj.decode()
    ...
    def test_parse_subtype(self):
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "Vec<UncleEntryItem<BlockNumber, Hash, AccountId>>"
        )
    ...
    def test_dynamic_fixed_array_type_decode(self):
        obj = RuntimeConfiguration().create_scale_object(
            "[u32; 1]", data=ScaleBytes("0x01000000")
        )
        self.assertEqual([1], obj.decode())

        obj = RuntimeConfiguration().create_scale_object(
            "[u32; 3]", data=ScaleBytes("0x010000000200000003000000")
        )
        self.assertEqual([1, 2, 3], obj.decode())

        obj = RuntimeConfiguration().create_scale_object(
            "[u32; 0]", data=ScaleBytes(bytes())
        )
    ...
    def test_create_multi_sig_address(self):
        ...
        multi_sig_account = MultiAccountId.create_from_account_list(
            [
                ...
                "HvqnQxDQbi3LL2URh7WQfcmi8b2ZWfBhu7TEDmyyn5VK8e2",
            ],
            2,
        )
    ...
    def test_opaque_call(self):
        ...
        call_value = {
            ...
            "call_args": {"_remark": "0x0123456789"},
        }
    ...
    def test_wrapped_opaque_decode_success(self):
        ...
        wrapped_obj = self.runtime_config_v14.create_scale_object(
            type_string="WrapperKeepOpaque", metadata=self.metadata_v14_obj
        )
    ...
    def test_wrapped_opaque_decode_fail(self):
        ...
        wrapped_obj.type_mapping = ("Compact<u32>", "Call")
        wrapped_obj.decode(ScaleBytes(opaque_hex))
        self.assertEqual("0x0a000022db73", wrapped_obj.value)
    ...
    def test_wrapped_opaque_encode(self):
        ...
        self.assertEqual("0x1805000022db73", wrapped_obj.data.to_hex())
    ...
    def test_multiaddress_ss58_address_as_str(self):
        ...
        decode_obj = RuntimeConfiguration().create_scale_object(
    ...
    def test_multiaddress_ss58_address_as_str_runtime_config(self):
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "Multiaddress", runtime_config=runtime_config
        )
        ss58_address = "CdVuGwX71W4oRbXHsLuLQxNPns23rnSSiZwZPN4etWf6XYo"

        data = obj.encode(ss58_address)
        decode_obj = RuntimeConfiguration().create_scale_object(
            "MultiAddress", data=data, runtime_config=runtime_config
        )
    ...
    def test_multiaddress_account_id(self):
        ...
        self.assertEqual(
            ...
            obj.encode(
                {
                    "Id": "0xf6a299ecbfec56e238b5feedfb4cba567d2902af5d946eaf05e3badf05790e45"
                }
            ),
        )
    ...
    def test_multiaddress_address20(self):
        ...
        obj.decode()
        self.assertEqual(
            {"Address20": "0x67f89207abe6e1b093befd84a48f033137659292"}, obj.value
        )
        self.assertEqual(
    ...
    def test_multiaddress_address32(self):
        obj = GenericMultiAddress(
            ScaleBytes(
                "0x03f6a299ecbfec56e238b5feedfb4cba567d2902af5d946eaf05e3badf05790e45"
            )
        )
        obj.decode()
        self.assertEqual(
    ...
    def test_multiaddress_bytes_pad(self):
        # Test decoding
        obj = GenericMultiAddress(data=ScaleBytes("0x02081234"))
        obj.decode()
        self.assertEqual({"Raw": "0x1234"}, obj.value)
        self.assertEqual(
        ...
        # Test encoding
        self.assertEqual(ScaleBytes("0x02081234"), obj.encode({"Raw": "0x1234"}))
    ...
    def test_account_id_runtime_config(self):
        ...
        # Encode
        obj = RuntimeConfiguration().create_scale_object(
            "AccountId", runtime_config=runtime_config
        )
        data = obj.encode(ss58_address)

        # Decode
        decode_obj = RuntimeConfiguration().create_scale_object(
            "AccountId", data=data, runtime_config=runtime_config
        )
        decode_obj.decode()
