...
class ScaleDecoder(ABC):
    ...
    def process_type(self, type_string: Union[str, dict], **kwargs: Any) -> "ScaleType": ...
...
class RuntimeConfigurationObject:
    ...
    def get_decoder_class(self, type_string: Union[str, dict]) -> Optional[Type[ScaleType]]: ...
    def _require_decoder_class(self, type_string: str) -> Type[ScaleType]: ...
    ...
    def add_contract_metadata_dict_to_type_registry(self, metadata_dict: dict) -> None: ...
    @overload
